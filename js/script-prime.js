...
function generatePlayBtns() {
    ...
    start.setAttribute(`class`, `play-btn d-block w-100 text-white my-3`)
    start.setAttribute(`id`, `play-button`)
    // start.setAttribute(`data-dismissal`, `modal`)
    ...
    select.append(optionInit)                               // initial "Choose Category" option box
    ...
    optD1.textContent = `Easy`
    optD2.textContent = `Medium`
